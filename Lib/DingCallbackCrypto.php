...
class DingCallbackCrypto
{
    ...
    public function getDecryptMsg($signature, $timeStamp = null, $nonce, $encrypt)
    {
        ...
        if ($ret != 0) {
			      throw new Exception(ErrorCode::$ComputeSignatureError);
        }

        $verifySignature = $array[1];
        if ($verifySignature != $signature) {
			      throw new Exception(ErrorCode::$ValidateSignatureError);
        }
...
class ErrorCode
{
	...
	public static $ParseXmlError = '40002: XML 解析失败';
	public static $ComputeSignatureError = '40003: SHA1 加密生成签名失败';
	...
	public static $IllegalBuffer = '40008: 解密后得到的 Buffer 非法';
	public static $EncodeBase64Error = '40009: Base64 加密失败';
	public static $DecodeBase64Error = '40010: Base64 解密失败';
	public static $GenReturnXmlError = '40011: 生成 XML 失败';
}
